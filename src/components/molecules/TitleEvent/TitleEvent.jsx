    ...
    return (
      <TitleMatchContainerStyles>
        ...
        <span className='dataEventSelected'>
          <p>
            <MdStadium className='iconStadium' />
            <small>{eventSelected[0].venue}</small>
          </p>
          <p>
            <TfiCup className='iconCup' />
            <small>{eventSelected[0].shareProps ? eventSelected[0].shareProps.tournament.replace("-", " ") : ''}</small>
          </p>
        </span>
      </TitleMatchContainerStyles>
    )
